...
# conda activate hdag-benchmark
# python $currdir/support_pipeline/scripts/cli.py save_supports -m "mrbayes" -t $ctree -i $tree_file -o $mrbayesdir/results.pkl
# echo ""
# echo ""

python /fh/fast/matsen_e/whowards/hdag-benchmark/support_pipeline/scripts/sandbox/mb_parsimony_distribution.py $trial
