...
[ -f $bigtree ] || wget -q http://hgdownload.soe.ucsc.edu/goldenPath/wuhCor1/UShER_SARS-CoV-2/2022/10/01/$bigtree
...
for clade in $(cat clades.txt); do
    ...
    phastSim --outpath $cladedir --seed 9 --createFasta --createInfo \
        --createNewick --createPhylip --treeFile $ntree \
             ...
             --reference refseq.fasta --eteFormat 0
    ...
    hdb collapse_tree $simtree $simfasta $ctree
done
